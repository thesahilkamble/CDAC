...
Separating  cross-cutting concerns(=repeatative tasks) from the core logic(eg logging)/ request handling (eg : exc handling, security)/persistence layer(eg : tx management)
