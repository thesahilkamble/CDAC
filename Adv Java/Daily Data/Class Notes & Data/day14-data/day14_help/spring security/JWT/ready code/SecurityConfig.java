...
public class SecurityConfig {
	...
	public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception {
		http.exceptionHandling().authenticationEntryPoint(
				...
				.antMatchers("/products/view", "/users/signin", "/users/signup", "/swagger*/**", "/v*/api-docs/**")
				...
				.sessionCreationPolicy(SessionCreationPolicy.STATELESS); // DO NOT use HttpSession for storing any security context info
		return http.build();
	}
